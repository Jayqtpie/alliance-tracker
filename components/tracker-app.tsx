      ...
      <aside className="commander-profile" role="dialog" aria-modal="true" aria-labelledby="commander-profile-title">
        ...
        <div className="profile-body">
          ...
          {(member.gameProfile || member.manualStats) && <section className="profile-metrics">
            <div><span>Power</span><strong>{stats.powerDisplay}</strong><small>{stats.power === null ? "Not available" : member.manualStats?.power !== undefined ? "Manually updated" : "Rounded display"}</small></div>
            <div><span>Hero power</span><strong>{stats.heroPowerDisplay}</strong><small>{stats.heroPower === null ? "Not available" : member.manualStats?.heroPower !== undefined ? "Manually updated" : member.gameProfile?.heroPowerMeasuredAt ? `Source ranking: ${dateLabel(member.gameProfile.heroPowerMeasuredAt)}` : "Rounded display"}</small></div>
            ...
            <div><span>Profession</span><strong>{stats.profession ?? "—"}</strong><small>{stats.profession === null ? "Not recorded" : member.manualStats?.profession !== undefined ? "Manually updated" : "Player profile"}</small></div>
